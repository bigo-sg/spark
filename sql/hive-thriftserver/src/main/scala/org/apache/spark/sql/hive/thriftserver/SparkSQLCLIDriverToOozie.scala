 ...
 */
private[hive] object SparkSQLCLIDriverToOozie extends Logging {
  ...
  def main(args: Array[String]) {
    ...
    if (sessionState.fileName != null) {
      try {
        retcli = cli.processFile(sessionState.fileName)
      } catch {
...
private[hive] class SparkSQLCLIDriverToOozie extends SparkSQLCLIDriver {
  ...
  override def printMasterAndAppId(): Unit = {
